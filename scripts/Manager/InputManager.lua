...
function ADInputManager:input_increaseSpeed(vehicle)
    if vehicle.ad.stateModule:getMode() == AutoDrive.MODE_SNOWPLOW then
        ADSnowPlowUtil.increaseSnowPlowSpeed(vehicle)
    else
...
function ADInputManager:input_decreaseSpeed(vehicle)
    if vehicle.ad.stateModule:getMode() == AutoDrive.MODE_SNOWPLOW then
        ADSnowPlowUtil.decreaseSnowPlowSpeed(vehicle)
    else
