...
function AutoDriveHud:createHudAt(hudX, hudY)
	...
	table.insert(self.hudElements, ADPullDownList:new(self.posX + 2 * self.gapWidth + self.buttonWidth, self.row3, self.iconWidth * 6 + self.gapWidth * 5, self.listItemHeight, ADPullDownList.TYPE_SNOW_TARGET_2, 1))

	table.insert(self.hudElements, ADHudButton:new(self.posX + self.gapWidth, self.row3, self.iconWidth, self.iconHeight, "input_snowPlowTargetIcon", nil, nil, nil, nil, nil, nil, nil, "", 1, true))

	table.insert(self.hudElements, ADPullDownList:new(self.posX + 2 * self.gapWidth + self.buttonWidth, self.row2, self.iconWidth * 6 + self.gapWidth * 5, self.listItemHeight, ADPullDownList.TYPE_SNOW_TARGET_3, 1))

	table.insert(self.hudElements, ADHudButton:new(self.posX + self.gapWidth, self.row2, self.iconWidth, self.iconHeight, "input_snowPlowTargetIcon", nil, nil, nil, nil, nil, nil, nil, "", 1, true))
...
function AutoDriveHud:getModeName(vehicle)
	...
	elseif vehicle.ad.stateModule:getMode() == AutoDrive.MODE_SNOWPLOW then
		return g_i18n:getText("AD_MODE_SNOWPLOW")
	end
